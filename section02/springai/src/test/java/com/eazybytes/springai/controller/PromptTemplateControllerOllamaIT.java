...
@TestPropertySource(properties = {
		"spring.ai.ollama.chat.options.model=" + PromptTemplateControllerOllamaIT.MODEL,
		"spring.ai.ollama.init.pull-model-strategy=never"
})
class PromptTemplateControllerOllamaIT {
	...
	@Test
	void real_model_drafts_email_from_template() throws Exception {
